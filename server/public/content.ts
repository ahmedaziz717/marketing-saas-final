...
export const ARTICLES: Record<string, Article> = {
  "/privacy": {
    ...
    intro:
      "How the Frame preview handles account information, creative assets, connected marketing data and requests from you. Updated September 21, 2026.",
    sections: [
      {
        title: "Who this notice covers",
        paragraphs: [
          "This notice covers the Frame public website and marketing workspace. The operating business and contact details appear in the Business information panel. When those details or approval of this notice are pending, the panel identifies the notice as a pre-release draft, not a completed verification declaration.",
          "For account administration, security and website enquiries, Frame handles information to operate its service. For marketing information a business connects to its workspace, Frame acts on that business's instructions. That business is also responsible for the permissions, rights and notices needed for its own customers and team members.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "When you authorize a Meta connection, Frame receives the account identity and authorization needed to discover and use the Pages or advertising accounts you select. Depending on permissions, this can include Page and account IDs and names, Page tasks, posts and aggregate engagement, campaigns, ad sets, ads, currency, time zone, spend, clicks and platform-reported conversions. Encrypted access credentials and connection metadata are stored separately for each workspace.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Frame uses Render for application hosting and Supabase for account authentication, database and asset storage. Authentication email is handled by the configured email service. The signed-in application loads fonts from Google Fonts, which receives the technical request information needed to deliver them. The new public pages use local/system typography rather than third-party font requests.",
      ...
      },
      {
        ...
        paragraphs: [
          "Meta access is authorized by each customer for their own workspace. Frame is not a shared CLX or other advertiser account. Credentials are encrypted on the server and are not returned in ordinary connection responses. The current product does not sell Meta Platform Data or make a customer's account data available as a cross-customer data product.",
          "Reports are based on the data the provider makes available. Platform-attributed conversions are not represented as independently deduplicated sales, and unique reach is not added across channels as though it were unique people. Frame does not claim Meta certification, partnership or completed review merely because a connection interface exists.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Working assets, account records and activity history remain available while needed for the workspace and service. Disconnecting a Meta connection removes its stored credential in Frame and invalidates affected queued approvals, but does not automatically erase prior drafts, publications or audit records. OAuth selection sessions expire and are cleaned up as the connection flow runs.",
          "You may request access, correction or deletion through the public Contact or Data deletion page without a Frame login. We need to verify identity and, for shared business data, authority before acting. A request receipt confirms receipt, not completed deletion. The platform team handles fulfillment; there is no instant workspace-erasure action in this release.",
          ...
          "For data your employer or another business controls, identify the workspace or contact that business as well. Available privacy rights vary by location and may include access, correction, deletion and objection or restriction. Contact us to exercise a right or ask about a decision. You do not have to delete your Facebook account to make a Frame request.",
        ],
      },
      {
        title: "Service location, audience and updates",
        paragraphs: [
          "Frame is a business marketing service, not a product directed to children. Do not upload sensitive personal information or children's data that is unnecessary to your task. Hosting and service providers may process information outside your location, including in the United States. Required contractual and transfer arrangements must be reviewed for the business and regions served before public launch.",
  ...
  "/terms": {
    ...
    intro:
      "Working terms for using Frame's pre-release marketing service. Updated September 21, 2026. Operator approval and legal review are required before commercial launch.",
    sections: [
      {
        title: "The service and its operator",
        paragraphs: [
          "Frame brings creative work, channel activation and reporting into one workspace. The Business information panel identifies the operator once confirmed. This preview is not a representation that every feature on the roadmap is available or approved by a third-party platform.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "You retain your rights in material you provide and permit Frame and its service providers to process it to deliver the tasks you request. You are responsible for permissions, licenses, product claims, privacy notices and any model or creator releases needed for your content. AI outputs can be inaccurate or unsuitable; review them before use.",
          "Asset approval and final publishing approval are separate. Review the selected account, content, schedule and action before authorizing delivery. The current Meta ad workflow creates paused image ads in existing ad sets; review and activation occur separately. Frame does not promise campaign results or replace the platform's own policies.",
        ],
      },
      {
        title: "Acceptable use",
        paragraphs: [
          "Do not use Frame for fraud, unlawful content, harassment, infringement, unauthorized account access or attempts to bypass approval and security controls. Do not upload secrets, unnecessary sensitive personal information, or information you are not entitled to process. Access may be restricted where needed to protect users, providers or the service.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "The Privacy notice explains current data handling. Use Settings > Integrations to disconnect an authorized account. Use the Data deletion page to request removal of data held by Frame. Disconnecting or closing a workspace does not itself delete posts or campaigns already held by Meta, or cancel activity configured directly in an external account.",
          "Public enquiries go to Frame's platform inbox. The team may need to verify authority before deleting shared business records or changing access. Contact us for questions, a privacy request or information about ending preview access.",
        ],
      },
    ],
  },
  "/data-deletion": {
    ...
    intro:
      "A public way to ask Frame to remove information it holds about you or a workspace you are authorized to manage. A Frame login is not required.",
    sections: [
      {
        title: "1. Stop future access when needed",
        paragraphs: [
          "A workspace owner or administrator can open Settings > Integrations, choose the connected account and select Disconnect. This removes the stored connection credential in Frame and invalidates affected queued approvals. You can also remove Frame's access through Meta's business-integration or app-access controls where it is listed.",
          "Disconnection is not the same as deletion. It does not automatically remove historical reports, creative assets, publishing records or audit information from Frame. You do not need to delete your Facebook account.",
        ],
      },
      {
      ...
      {
        title: "What a Frame deletion does not do",
        paragraphs: [
          "A request to Frame does not delete your Facebook Page, Meta account, published posts, or ads already created on Meta. Manage or remove that external content directly in Meta. Disconnecting Frame also does not pause a campaign that is already running on an external platform.",
  ...
  "/security": {
    ...
    intro:
      "The safeguards implemented in Frame, and the limits we want you to understand before connecting a business account.",
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Integration credentials are encrypted on the server. Private media uses an authenticated storage path. Customers authorize their own connected accounts through the provider flow rather than entering Frame's platform secret. Never send an access token or password through a support form.",
        ],
      },
      {
