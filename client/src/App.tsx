...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/signup"><LoginPage signup /></Route>
      <Route path="/reset-password"><LoginPage resetPassword /></Route>
      ...
      <Route path="/app/activity"><Redirect to="/app/settings/activity" replace /></Route>
